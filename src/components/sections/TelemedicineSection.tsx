        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <RevealOnScroll>
            <div className="relative">
              ...
              <div className="rounded-3xl border border-white/15 bg-gradient-to-b from-[#151c2e]/95 to-[#0b101d]/95 p-5 shadow-2xl backdrop-blur-2xl">
                {/* Video call header */}
                ...
                <div className="relative rounded-2xl bg-gradient-to-br from-violet-900/30 via-[#1a1030] to-[#0d0620] border border-white/5 aspect-video flex items-center justify-center overflow-hidden">
                ...
                <div className="flex items-center justify-center gap-3 mt-4 pt-3 border-t border-white/5">
                  <button className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 border border-white/10 text-white hover:bg-white/15 transition-colors">
                  ...
                  <button className="flex h-11 w-11 items-center justify-center rounded-full bg-red-500/80 text-white hover:bg-red-500 transition-colors shadow-lg shadow-red-500/25">
                    <PhoneOff className="h-4 w-4" />
                  </button>
                </div>

                {/* In-call mini ticket */}
                <div className="mt-4 rounded-xl border border-violet-500/20 bg-violet-500/5 p-3 flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
