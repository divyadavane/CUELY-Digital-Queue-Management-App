  ...
  return (
    <section className="py-28 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
        <RevealOnScroll className="rounded-3xl border border-[var(--border-color)] bg-[var(--bg-card)] p-8 sm:p-16 backdrop-blur-2xl shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="inline-flex items-center gap-3 rounded-full border border-blue-400/40 bg-blue-400/15 px-5 py-2 text-xs font-bold text-blue-500 mb-8 shadow-md shadow-blue-500/20">
              <CuelyLogo size="sm" showGlow />
              <span className="text-[var(--text-primary)] font-extrabold">Ready to transform your lobby?</span>
            </div>

            <h2 className="text-3xl sm:text-6xl font-black text-[var(--text-primary)] tracking-tight leading-tight">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-6 pt-8 border-t border-[var(--border-color)] text-xs font-medium text-[var(--text-secondary)] w-full">
